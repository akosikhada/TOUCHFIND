            ...
            <div class="container-fluid px-4 py-4">
                <div class="admin-header-container">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="admin-page-title mb-0">LIST OF PRODUCTS</h1>
                ...
                <div class="search-container d-md-none">
                    <h1 class="admin-page-title mb-3">LIST OF PRODUCTS</h1>
                                ...
                                if ($result && $result->num_rows > 0):
                                    while ($product = $result->fetch_assoc()):
                                        ...
                                        $imagePath = !empty($product['product_image']) ? $product['product_image'] : '../assets/placeholder.png';
                                            $description = truncateDescription($product['product_description'], 20);
                                ?>
                                <tr>
                                        <td data-label="IMAGE" class="text-center">
                                            <div class="d-md-none mobile-product-card">
                                                <div class="product-image mb-2 mx-auto">
                                                    <img src="<?= $imagePath ?>" alt="<?= htmlspecialchars($product['product_name']) ?>" class="img-fluid">
                                                </div>
                                                <div class="product-info-mobile text-center">
                                    ...
                                    <td data-label="PRODUCT">
                                        ...
                                        <td data-label="DESCRIPTION">
                                            <span class="product-description"><?= htmlspecialchars($description) ?></span>
                                            <input type="hidden" class="full-product-description" value="<?= htmlspecialchars($product['product_description']) ?>">
                                        </td>
                                    ...
                                    <td data-label="STOCK"><span class="stock-badge <?= $stockClass ?>"><?= $stock ?></span></td>
                                        <td data-label="LOCATION"><span class="shelf-location"><?= htmlspecialchars($shelf) ?></span></td>
                                        <td data-label="PRICE"><span class="price-value">₱<?= number_format($product['product_price'], 2) ?></span></td>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function searchProducts(searchTerm) {
                ...
                if (searchTerm.length > 0) {
                    if (matches === 0) {
                        showNotification(`No products match "${searchTerm}"`, 'warning');
                    }
                }
            }
